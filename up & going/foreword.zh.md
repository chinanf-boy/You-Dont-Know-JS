...
也许这是一种外语,像意大利语或德语. 也许这是一个图形编辑器,如PS图象处理软件. 或烹调技术ㄡ木工或锻炼程序. 我想让你记住的感觉当你终于找到它: 灯泡的时刻. 当事情从模糊变得清晰时,当你掌握桌子时,就会看到或理解法语中阳性和阴性名词的区别. 感觉怎么样?很神奇,对吧?
...
我一直相信以正确的方式教授我的课程,这意味着我教Web标准ㄡ语义标记ㄡ注释良好的代码和其他最佳实践. 我盖在一个彻底的方式主题解释如何和为什么,而不只是把代码复制和粘贴. 当你努力理解你的代码时,你就会创造更好的工作,并更好地做你所做的事情. 代码不只是你的_工作_这是你的_工艺_. 这就是我爱的原因_起来,去_. Kyle通过语法和术语深入地介绍了JavaScript,而不用偷工减料. 这本书没有掠过表面,但真正让我们真正理解我们将要写的概念. 
...
您接触JavaScript的次数越多,它就越清晰. 像闭包ㄡ对象和方法之类的词现在似乎对你来说是遥不可及的,但是这本书将帮助这些术语变得清晰. 在你开始这本书之前,我想让你记住这两种感觉. 这似乎有些让人气馁,但你已经拿起这本书,因为你正在开始一次可怕的旅程来磨练你的知识. _起来,去_是我们理解程序设计的开始. 享受灯泡时刻!
